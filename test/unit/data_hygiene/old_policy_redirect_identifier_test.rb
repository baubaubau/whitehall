...
module DataHygiene
  class OldPolicyRedirectIdentifierTest < ActiveSupport::TestCase
    ...
    test "returns the URL for the corresponding future-policy" do
      ...
      identifier = OldPolicyRedirectIdentifier.new(policy)
    ...
    test "returns the URL for the policy paper for retired policies" do
      ...
      identifier = OldPolicyRedirectIdentifier.new(retired_policy)
